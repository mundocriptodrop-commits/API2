...
export default function ClientApiTab() {
  ...
  const handleTest = async () => {
    ...
    try {
      ...
      // A atualização automática do webhook no Chatwoot é feita pelo Cloudflare Worker (backend)
      // para evitar problemas de CORS. O resultado vem na resposta com os campos:
      // - webhook_updated_in_chatwoot: true/false
      // - webhook_update_error: objeto com detalhes do erro (se houver)
